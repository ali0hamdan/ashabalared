...
export class DistributionController {
  ...
  assignDriverPatch(@CurrentUser() actor: AuthUser, @Param('id') id: string, @Body() dto: AssignDriverDto) {
  ...
  assignDriverPost(@CurrentUser() actor: AuthUser, @Param('id') id: string, @Body() dto: AssignDriverDto) {
  ...
  confirmDelivery(@CurrentUser() actor: AuthUser, @Param('id') id: string, @Body() dto: DeliverDistributionDto) {
  ...
  forceDelete(@CurrentUser() actor: AuthUser, @Param('id') id: string, @Body() dto: ForceDeleteDto) {
    ...
    return this.distribution.forceRemove(actor, id, dto.confirmationText, dto.reason);
